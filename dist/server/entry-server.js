...
const aboutBlock = { "name": "Компания НП ООО «БЕРЛИО»", "lider": { "alt": "Логотип конкурса", "title": "ЛИДЕР ЦИФРОВОЙ ЭКОНОМИКИ 2024", "blockTitle1": "Номинация", "blockText1": "ПРОГРАММНО-АППАРАТНЫЙ ПРОДУКТ ГОДА", "blockTitle2": "Категория", "blockText2": "ТОРГОВЛЯ И УСЛУГИ ДЛЯ БИЗНЕСА", "blockTitle3": "Награда", "blockText3": "ДИПЛОМ ПОБЕДИТЕЛЯ I СТЕПЕНИ" }, "alt": "Офис НП ООО «БЕРЛИО»", "description1": "НП ООО «БЕРЛИО» – белорусский разработчик, производитель, сервисный центр обслуживания, на рынке производителей и услуг с 1992 года.", "description2-1": "Победитель республиканского конкурса", "description2-2": "«Лидеры цифровой экономики 2024» в номинации «Программно-аппаратный продукт года».", "description3-1": "Диплом I степени", "description3-2": "за продукт «Электронная платежная система «Берлио».", "awardingSubTitle": "Награждение", "description4": "*использована фотография из архива оргкомитета республиканского конкурса «Лидеры цифровой экономики — 2024»", "description5": "Оператор и процессинговый центр инновационной электронной платёжной системы «Берлио» позволяющей производить оплату за нефтепродукты, товары и услуги, плату за проезд по автомобильным дорогам Республики Беларусь («BelToll») в организациях торговли и сервиса (ОТС) с использованием электронных карт «Берлио».", "description6": "Электронная платёжная система «Берлио» зарегистрирована Национальным Банком Республики Беларусь в реестре поставщиков платежных услуг и видов платежных услуг, оказываемых ими.", "description7": "Количество участников электронной платёжной системы «Берлио» – около 800 ОТС.", "documents": { "title": "Регистрационные документы НП ООО «БЕРЛИО»:", "list": { "item1": "Свидетельство о государственной регистрации", "item2": "Устав", "item3": "Реестр поставщиков платежных услуг и видов оказываемых ими платежных услуг" }, "info": { "title1": "Информация о платежных услугах:", "description1": "Оператор является поставщиком платежных услуг по организации и функционированию электронной платёжной системы «Берлио» (ЭПС «Берлио»), устанавливает правила в системе. Оказывает платежные услуги инициирования платежа, эмиссии (создания) или распространения платежного инструмента электронных денег, платежные услуги процессинга, информационные платежные услуги.", "title2": "Регистрационный номер поставщика платежных услуг:", "description2": "112.100191549.1-0-3-0-5.0010-0-0-8-9", "title3": "Расчётные операции в ЭПС «Берлио»:", "description3": "Эмитент электронных денег «Берлио» и расчётный центр – ОАО «Белгазпромбанк»." } } };
...
const forClientsMain = { "title": "Для клиентов", "description": "Выберите раздел и изучите необходимую информацию", "clientInfo": { "title1": "Электронные карты «Берлио»", "title2": "Топливные карты «Берлио»", "title3": "Документы", "title4": "Сервисы и ПО", "label1": "Обслуживание в ЭПС «Берлио»", "label2": "Оплата товаров (работ, услуг)", "label3": "Заключение договора ЭПС «Берлио»", "label4": "Формы и списки документов (для скачивания)", "label5": "Получение электронной карты", "label6": "Работа с личным кабинетом", "label7": "Обслуживание в «BelToll»", "label8": "Плата за проезд «BelToll»", "label9": "Заключение договора «BelToll»", "label10": "Оплата топлива на АЗС", "label11": "Выпуск в обращение и использование топливных карт", "label12": "Законодательство", "label13": "Отчёт об оценке ИФР", "label14": "Локально-правовые акты ЭПС «Берлио»", "label15": "Приложение “Berlio Internet client”", "label16": "Приложение “BERLIOCARDPAY”", "label17": "Приложение “Smartpay”", "label18": "Касса самообслуживания для сетей АЗС", "label19": "ПО “Личный кабинет клиента”" } };
