...
const CookieConsentPolicy = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ React__default.createElement("div", { className: "aam_privacy-page" }, /* @__PURE__ */ React__default.createElement("h2", { className: "aam_privacy-page__title" }, t("privacyMain.cookieConsentPolicy")), /* @__PURE__ */ React__default.createElement("div", { className: "aam_privacy-page__content" }));
};
const BuyersPolicy = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ React__default.createElement("div", { className: "aam_privacy-page" }, /* @__PURE__ */ React__default.createElement("h2", { className: "aam_privacy-page__title" }, t("privacyMain.buyersPrivacy")), /* @__PURE__ */ React__default.createElement("div", { className: "aam_privacy-page__content" }));
};
const B2BPolicy = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ React__default.createElement("div", { className: "aam_privacy-page" }, /* @__PURE__ */ React__default.createElement("h2", { className: "aam_privacy-page__title" }, t("privacyMain.b2bPrivacy")), /* @__PURE__ */ React__default.createElement("div", { className: "aam_privacy-page__content" }));
};
