        ...
        <g fill="#333333" fontFamily="Sans" fontStyle="italic" fontWeight="bold" strokeLinecap="round">
          <g fontSize="4px">
            {[...Array(10)].map((_, i) => {
              ...
              const xValues = [
                38.99, 48.86, 59.11, 68.86, 38.61, 48.48, 58.86, 68.73, 48.61, 58.98,
              ];
              const yValues = [
                78.22, 80.17, 80.17, 77.67, 87.17, 90.04, 90.04, 87.92, 100.92, 100.92,
              ];
          ...
          <g fontSize="1.99px">
            {[
              {
                id: 'cs', x: 68.04, y: 96.84, text: t('readerSVG.enter'),
              }, /* "Ввод" */
              {
                id: 'cu', x: 38.04, y: 96.84, text: t('readerSVG.cancel'),
              }, /* "Сброс" */
              {
                id: 'cw', x: 38.34, y: 69.84, text: t('readerSVG.return'),
              }, /* "Возврат" */
              {
                id: 'cy', x: 66.84, y: 69.84, text: t('readerSVG.doze'),
              }, /* "Доза" */
              {
                id: 'da', x: 49.11, y: 70.97, text: t('readerSVG.menu'),
              }, /* "Меню" */
              {
                id: 'dc', x: 57.49, y: 70.97, text: t('readerSVG.lang'),
              }, /* "Язык" */
            ].map(({
              id, x, y, text,
            }) => (
            ...
            <text
              ...
              strokeWidth=".2"
              style={{
                fontVariantCaps: 'normal', fontVariantEastAsian: 'normal', fontVariantLigatures: 'normal', fontVariantNumeric: 'normal', fontStyle: 'normal', paintOrder: 'markers stroke fill',
              }}
              xmlSpace="preserve"
            >
              <tspan id="df" x="30.686155" y="40.978397" />
              <tspan id="dg" x="30.686155" y="47.645061" />
            </text>
          </g>
        </g>
      </g>
