...
function ForBankInformationContactSection() {
  ...
  const {
    departmentsName, footerShortAddress, phoneNumber, email, departmentsImage,
  } = displayedItem;
      ...
      <div className="aam_for-bank-info-contact-section__address">
        ...
        <div className="aam_for-bank-info-contact-section__contact-address">
          <div className="aam_for-bank-info-contact-section__section">
            <p>
              <strong>
                {t('forBankInfoContact.address')}
                :
              </strong>
              {' '}
              {t(footerShortAddress)}
            </p>
          </div>
          <div className="aam_for-bank-info-contact-section__section">
            <p className="aam_for-bank-info-contact-section__phone">
              <strong>
                {t('forBankInfoContact.phone')}
                :
              </strong>
              {' '}
              {phoneNumber[0]}
          ...
          <div className="aam_for-bank-info-contact-section__section">
            <p className="aam_for-bank-info-contact-section__email">
              <strong>
                {t('forBankInfoContact.forOrganizations')}
                :
              </strong>
              {' '}
              {email[0]}
            ...
            <p className="aam_for-bank-info-contact-section__email">
              <strong>
                {t('forBankInfoContact.forClientInquiries')}
                :
              </strong>
              {' '}
              {email[1]}
