        ...
        <main className="aam_personal-acc-web-app-main">
            ...
            <div className="aam_personal-acc-web-app-main__wrapper">
                ...
                <div className="aam_personal-acc-web-app-main__wrapper--description">
                    ...
                    <p className="aam_personal-acc-web-app-main__wrapper--description-sub-title">{t('personalAccWebAppMain.description.subTitle')}{' '}<Link to="https://lkb.by">https://lkb.by</Link></p>
                    <div>
