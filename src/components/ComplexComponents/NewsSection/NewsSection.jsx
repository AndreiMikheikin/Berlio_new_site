...
const NewsSection = () => {
    ...
    const sortedNews = newsArray
        .filter((newsItem) => isValidDate(newsItem.dates.startDate, newsItem.dates.expireDate)) // Учитываем дату
        .sort((a, b) => {
            ...
            {featuredNews && (
                <>
                    ...
                    <div className="aam_news-section__navigation">
                        <button className="aam_news-section__nav-button" onClick={handlePrev}>
                            <LeftArrowIcon />
                        </button>
                        <button className="aam_news-section__nav-button" onClick={handleNext}>
                            <RightArrowIcon />
                        </button>
