...
const GettingElectronicCardMain = () => {
        ...
        <main className="aam_getting-card-main">
            ...
            <div className="aam_getting-card-main__description">
                ...
                <ul className="aam_getting-card-main__description--list">
                    ...
                    <li>{t('gettingCardMain.list1.item3')}{" "}<a href="mailto:info@berlio.by" rel="noopener noreferrer">{t('gettingCardMain.mailLink')}</a></li>
                </ul>
            ...
            <div className="aam_getting-card-main__documents">
                ...
                <div className="aam_getting-card-main__documents--footer">
                    <p className="aam_getting-card-main__documents--footer-primary"><strong>
                        {t('gettingCardMain.documentsFotterPrimary')}
                    </strong></p>
                    <p className="aam_getting-card-main__documents--footer-secondary"><strong>
