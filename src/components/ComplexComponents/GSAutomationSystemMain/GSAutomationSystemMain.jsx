  ...
  return (
    <main className="aam_gs-automation-system-main">
      ...
      <div className="aam_gs-automation-system-main__wrapper">
        ...
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          {t('gsAutomationSystemMain.list1.firstSubTitle')}
          <strong>{t('gsAutomationSystemMain.list1.firstSubTitleBold')}</strong>
        </p>
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          <strong>{t('gsAutomationSystemMain.list1.secondSubTitleBold')}</strong>
          {t('gsAutomationSystemMain.list1.secondSubTitle')}
        </p>
      ...
      <div className="aam_gs-automation-system-main__wrapper">
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          {t('gsAutomationSystemMain.list2.firstSubTitle')}
          <strong>{t('gsAutomationSystemMain.list2.firstSubTitleBold')}</strong>
        </p>
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          <strong>{t('gsAutomationSystemMain.list2.secondSubTitleBold')}</strong>
          {t('gsAutomationSystemMain.list2.secondSubTitle')}
        </p>
      </div>
      ...
      <div className="aam_gs-automation-system-main__wrapper">
        ...
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          {t('gsAutomationSystemMain.list3.firstSubTitle')}
          <strong>{t('gsAutomationSystemMain.list3.firstSubTitleBold')}</strong>
        </p>
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          <strong>{t('gsAutomationSystemMain.list3.secondSubTitleBold')}</strong>
          {t('gsAutomationSystemMain.list3.secondSubTitle')}
        </p>
      </div>

      <div className="aam_gs-automation-system-main__wrapper">
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          {t('gsAutomationSystemMain.list4.firstSubTitle')}
          <strong>{t('gsAutomationSystemMain.list4.firstSubTitleBold')}</strong>
        </p>
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          <strong>{t('gsAutomationSystemMain.list4.secondSubTitleBold')}</strong>
          {t('gsAutomationSystemMain.list4.secondSubTitle')}
        </p>
      </div>

      <div className="aam_gs-automation-system-main__wrapper">
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          {t('gsAutomationSystemMain.list5.firstSubTitle')}
          <strong>{t('gsAutomationSystemMain.list5.firstSubTitleBold')}</strong>
        </p>
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          <strong>{t('gsAutomationSystemMain.list5.secondSubTitleBold')}</strong>
          {t('gsAutomationSystemMain.list5.secondSubTitle')}
        </p>
      </div>

      <div className="aam_gs-automation-system-main__wrapper">
        <p className="aam_gs-automation-system-main__wrapper--sub-title">
          {t('gsAutomationSystemMain.list6.firstSubTitle')}
          <strong>{t('gsAutomationSystemMain.list6.firstSubTitleBold')}</strong>
        </p>
